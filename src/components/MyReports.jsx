...
export default function MyReports() {
    ...
    const getAllReports = async () => {
        // console.log(state)
        fetch(`https://mcq-ace.onrender.com/report/${state.teacher._id}`, { method: "get", headers: { "Authorization": `Bearer ${state.teacher.token}` } })
            .then(res => res.json())
            .then(data => {
                if (data.error) {
    ...
    const deleteReport = async (reportID) => {
        ...
        fetch(`https://mcq-ace.onrender.com/report/delete/${reportID}`, { method: "get", headers: { "Authorization": `Bearer ${state.teacher.token}` } })
            .then(res => res.json())
            .then(data => {
                if (data.message) {
